...
// the full recompute.
['leaderboard_last_check', 'looks_leader_user_id', 'networth_leader_user_id', 'level_leader_user_id', 'height_leader_user_id', 'kollector_leader_user_id'].forEach((col) => {
...
function getLeaderboardState() {
  return db
    .prepare(
      'SELECT leaderboard_last_check, looks_leader_user_id, networth_leader_user_id, level_leader_user_id, height_leader_user_id, kollector_leader_user_id FROM server_state WHERE id = 1'
    )
    .get();
}
